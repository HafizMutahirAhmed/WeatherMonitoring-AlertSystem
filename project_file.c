...
void get_current_weather(const char *json_data) {
    ...
    if (json_object_object_get_ex(parsed_json, "current", &current)) {
        ...
        if (current_temp > 25.0) {
            printf("\033[1;31m*** ALERT: Today's average temperature exceeds 30°C! ***\033[0m\n");
            ...
            sendEmailNotification(alert_subject, alert_body, "mutahirahmed001@gmail.com"); // Replace with your recipient email
